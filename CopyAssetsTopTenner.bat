...
Powershell.exe -noexit -executionpolicy bypass -command "& './CopyAssets.ps1' -DestinationPath '%destinationPath%' -SourcePath '%sourcePathMotion%' -SourcePathSecond '%sourcePathSpine%'"